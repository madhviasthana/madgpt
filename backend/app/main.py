...
def madhvi_query(state : AgentState):
...
About Madhvi : 
Madhvi Asthana
madhviasthana9@gmail.com | +49 15730252898
Berlin, Germany | Linkedin | Github
SUMMARY
Highly motivated AI and technology student with hands-on experience in technical support, customer engagement, and digital transformation. Passionate about leveraging cutting-edge Microsoft technologies to drive business solutions and enhance customer satisfaction. Proven track record in understanding customer needs, providing technical demonstrations, and solving blockers to achieve seamless solution implementations.
SKILLS
Programming and Development
Python, R, Java, SQL, NoSQL, Vue.js, Web Development, Git, Docker
Data Visualization
Pandas, NumPy, Power BI, Data Integration, Data Pipeline Development, Data Interpretation
AI & Machine Learning:
Machine Learning, TensorFlow, Statistical Analysis, Predictive Modeling
Microsoft Tools:
Power BI, Microsoft Excel, familiarity with Microsoft Suite.
Customer Engagement:
Technical support, product demonstrations, solution implementation
Leadership & Soft Skills:
Collaboration, Problem Solving, Teamwork, Communication, adaptability, willingness to learn, customer focus.
LEADERSHIP & COMMUNITY INVOLVEMENT
Microsoft Student Ambassador (Beta)
India, Remote
Microsoft
11/2018 – 09/2020
● Led the creation of a virtual program that provided insights into the Microsoft Student Ambassador (MSP) application process, with participation from Microsoft Program Managers from Europe and Asia.
● Organized and hosted workshops and virtual sessions
● Engaged with a global student community, promoting Microsoft technologies and supporting peers through informative webinars and interactive sessions..
Co-Founder & Community Manager
Remote
GeeksGod
12/2019 – 02/2021
● Spearheaded digital marketing strategies that increased platform engagement, focusing on understanding customer needs and improving user experiences.
● Assisted in managing technical infrastructure, ensuring seamless operation of the platform while supporting customer queries and problem-solving.
PROJECTS
Credit Risk Modeling
● Collaborated on building data-driven models for risk assessment using machine learning techniques, focusing on delivering actionable insights to support business decisions.
Blinkit (E-Commerce) Interactive Dashboard:
● Developed a comprehensive Power BI dashboard to analyze Blinkit sales data and key performance metrics. Integrated multiple data sources to visualize sales trends, product performance, and customer behavior patterns.
Text to Image Generator using OpenAI:
● Users can input descriptive text, which is then processed by OpenAI's DALLE 2 model to generate corresponding images, while a Vue 3 Frontend provides a modern, interactive UI for users to enter prompts and view generated images in real-time.
EXPERIENCE
Student Developer
Frankfurt Oder, Germany
IHP: Leibniz Institute for High Performance Microelectronics
09/2024 – Present
● Assisted in Python-based projects related to hardware interfacing, contributing to operational improvements.
● Configured and managed pin assignments to optimize board performance and reliability.
Research Assistant
Dresden, Germany
Fraunhofer IPMS
10/2023 – 09/2024
● Preprocessed and cleaned time series data to enhance quality assurance, ensuring datasets were ready for further analysis.
● Collaborated on projects involving predictive model development, enhancing data collection and preprocessing
Student Assistant
Cottbus, Germany
Brandenburgische Technische Universität
05/2023 – 01/2024
● Supported team efforts to improve vehicle routing solutions, contributing to a 20% efficiency improvement while learning advanced algorithmic techniques
System Engineer
Mumbai, India
Tata Consultancy Services (TCS)
04/2021 – 09/2022
● Developed customer segmentation dashboards
● Testing and debugging of the code using JUnit framework
EDUCATION
M.Sc Artificial Intelligence
10/2022 – 04/2026 (Expected)
...
"""
    ...
    formatted_prompt = prompt.format_messages(user_query= state['messages'][-1].content)
...
workflow.add_node('RAG', madhvi_query)
...
app = FastAPI(root_path="/api", title="MadGPT API", version="1", description="MadGPT API Server using langchain")
